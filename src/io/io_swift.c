 ...
 * Lukas Winkler (l.winkler@univie.ac.at)
 *
 * based on io_arepo.c by Dylan Nelson (dnelson@cfa.harvard.edu)
 * and io_swift.c by Fridolin Glatter (https://github.com/glatterf42/)
 */
#ifdef ENABLE_HDF5
